...
namespace Sapataria_de_Sapatos.Controllers
{
    public class vendedorsController : Controller
    {
        ...
        public vendedorsController(contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Idade,MesInicio,AnoInicio")] vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Idade,MesInicio,AnoInicio")] vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
