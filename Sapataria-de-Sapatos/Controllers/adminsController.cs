    ...
    public class adminsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Admins != null ? 
                          ...
                          Problem("Entity set 'contexto.Admins'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Gerente,token")] admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Gerente,token")] admin admin)
        {
            if (id != admin.Id)
            {
                return NotFound();
